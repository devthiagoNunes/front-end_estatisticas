  ...
  return (
    ...
    >
      <p>
        ...
        {`Empresas ${context.state.empresasAbertas ? 'Abertas Por Setor' : 'Ativas Por Atividade'}`}
        <CSVLink className='icon-download-csv' data={dataToDownload} filename={"setor-empresa"}
