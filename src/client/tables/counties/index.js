...
const AlternationTablesStyle = styled.section`
.municipio {
    width: 100%;
    max-width: 500px;
    height: 100%;
...
.total-empresasAbertas p:first-child {
    margin: 0;
    padding: 0.8rem 0;
    font-size: 1.3rem;
    font-weight: bold;
...
.total-empresasAbertas p:last-child {
    margin: 0;
    position: absolute;
    width: 100%;
    height: 100%;
      ...
      <div className="municipio">
        {(window.innerWidth >= 320 && window.innerWidth < 768) ? null : <div className="total-empresasAbertas">
          ...
          <div className='table'>
            ...
            <CreateTable arr_dados={counties} table_name='Município' />
          </div>
