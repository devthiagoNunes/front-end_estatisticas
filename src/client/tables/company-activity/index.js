...
export default ({arr_data_company_activity}) => {

  const [popupVisible, setPopoupVisible] = useState(false);

  const dataToDownload = [
    ['atividade', 'quantidade'],
    ...arr_data_company_activity
  ]
