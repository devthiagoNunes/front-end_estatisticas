      ...
      <StyleCapitalSocial empresasAbertas={context.state.empresasAbertas}>
        <div className="table-capital">
          <div className='table'>
            ...
            {replyToCorporateNameParsed.length && <CreateTable table_name='Capital Social' arr_dados={replyToCorporateNameParsed} />}
          </div>
        </div>
      </StyleCapitalSocial>
    </React.Fragment>
